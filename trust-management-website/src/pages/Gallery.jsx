  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-8">
        <button className="bg-amber-50 hover:bg-amber-100 text-stone px-4 py-2 rounded-lg font-semibold">All</button>
        ...
        {galleryItems.map((item) => (
          <div key={item.id} className="card hover:shadow-xl transition duration-300">
            ...
            <div className="text-center">
              <span className="bg-amber-50 text-stone-800 px-2 py-1 rounded text-sm mb-2 inline-block">
                {item.category}
              </span>
      ...
      <div className="text-center mt-12">
        <button className="bg-stone-400 hover:bg-stone-500 text-white px-8 py-3 rounded-lg font-semibold text-lg transition">
          Load More
        </button>
      </div>
    </div>
